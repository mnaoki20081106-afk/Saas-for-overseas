  ...
  if (!env.pinterest.configured) {
    add({
      ...
      steps: [
        ...
        "pinterest.com を開き、右上の「Sign up / 登録」→ 登録フォームの下にある「ビジネスアカウントを作成 / Create a business account」のリンクを押す",
        "（見つからない場合）business.pinterest.com を開いて右上の「Sign up」からでも同じ画面に入れます",
        "メールアドレス・パスワード・生年月日を入力して作成",
        "プロフィール（ビジネス名・ロゴ・ウェブサイトURL・国・言語）を入力。国は United States、言語は English にしてください（英語圏に配信するため）",
        "広告を出すか聞かれたら「今はしない」で構いません",
        "※ 既に個人アカウントを持っている場合は、プロフィールメニューからビジネスアカウントへの切り替え・追加もできます",
      ],
      blocks: ["ピンの投稿全般"],
    });
